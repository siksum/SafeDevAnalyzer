...
from slither_core.core.declarations import Modifier
...
from slither_core.slithir.variables.tuple_ssa import TupleVariableSSA
...
class InternalCall(Call, OperationWithLValue):  # pylint: disable=too-many-instance-attributes
    def __init__(
        ...
        nbr_arguments: int,
        result: Optional[
            Union[TupleVariableSSA, TemporaryVariableSSA,
                  TupleVariable, TemporaryVariable]
        ],
        type_call: str,
    ) -> None:
        super().__init__()
