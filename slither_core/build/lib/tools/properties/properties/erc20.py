...
from slither_core.tools.properties.platforms.echidna import generate_echidna_config
from slither_core.tools.properties.properties.ercs.erc20.properties.burn import (
    ERC20_NotBurnable,
    ERC20_Burnable,
)
from slither_core.tools.properties.properties.ercs.erc20.properties.initialization import ERC20_CONFIG
from slither_core.tools.properties.properties.ercs.erc20.properties.mint import ERC20_NotMintable
from slither_core.tools.properties.properties.ercs.erc20.properties.mint_and_burn import (
    ERC20_NotMintableNotBurnable,
)
from slither_core.tools.properties.properties.ercs.erc20.properties.transfer import (
    ERC20_Transferable,
    ERC20_Pausable,
)
from slither_core.tools.properties.properties.ercs.erc20.unit_tests.truffle import generate_truffle_test
from slither_core.tools.properties.properties.properties import (
    property_to_solidity,
    Property,
)
from slither_core.tools.properties.solidity.generate_properties import (
    generate_solidity_properties,
    generate_test_contract,
    generate_solidity_interface,
)
from slither_core.utils.colors import red, green
