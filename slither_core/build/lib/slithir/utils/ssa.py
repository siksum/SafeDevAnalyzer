...
import slither_core.slithir.variables.tuple_ssa
...
from slither_core.core.declarations.modifier import Modifier
...
from slither_core.slithir.operations.operation import Operation
...
def add_ssa_ir(
    ...
    all_state_variables_instances: Dict[
        str, slither_core.slithir.variables.state_variable.StateIRVariable
    ],
) -> None:
    """
