...
from slither_core.utils.code_complexity import compute_cyclomatic_complexity
...
class FunctionContract(Function, ContractLevel):
    ...
    def generate_slithir_ssa(
        ...
        from slither_core.slithir.utils.ssa import add_ssa_ir, transform_slithir_vars_to_ssa
        from slither_core.core.dominators.utils import (
