...
from slither_core.tools.properties.platforms.truffle import (
    generate_migration,
    generate_unit_test,
)
from slither_core.tools.properties.properties.ercs.erc20.properties.initialization import ERC20_CONFIG
from slither_core.tools.properties.properties.properties import Property
...
def generate_truffle_test(
    ...
    output_dir = Path(contract.compilation_unit.core.antibug_compile.target)
