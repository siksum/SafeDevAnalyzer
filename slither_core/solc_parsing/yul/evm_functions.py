from slither_core.core.declarations.solidity_variables import SOLIDITY_FUNCTIONS
from slither_core.core.expressions import BinaryOperationType, UnaryOperationType
