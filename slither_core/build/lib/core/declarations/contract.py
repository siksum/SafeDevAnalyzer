...
from slither_core.core.declarations.function import Function, FunctionType, FunctionLanguage
from slither_core.utils.erc import (
    ERC20_signatures,
    ERC165_signatures,
    ERC223_signatures,
    ERC721_signatures,
...
from slither_core.utils.tests_pattern import is_test_contract

# pylint: disable=too-many-lines,too-many-instance-attributes,import-outside-toplevel,too-many-nested-blocks
if TYPE_CHECKING:
    from slither_core.utils.type_helpers import LibraryCallType, HighLevelCallType, InternalCallType
    ...
    from slither_core.core.variables import Variable, StateVariable
...
class Contract(SourceMapping):  # pylint: disable=too-many-public-methods
    ...
    def is_upgradeable_proxy(self) -> bool:
        ...
        from slither_core.slithir.operations import LowLevelCall
    ...
    def convert_expression_to_slithir_ssa(self) -> None:
        ...
        :return:
        """
        from slither_core.slithir.variables import StateIRVariable
