...
if TYPE_CHECKING:
    ...
    from slither_core.core.declarations.enum import Enum
...
class UserDefinedType(Type):
    ...
    def __str__(self) -> str:
        from slither_core.core.declarations.structure_contract import StructureContract
        from slither_core.core.declarations.enum_contract import EnumContract
