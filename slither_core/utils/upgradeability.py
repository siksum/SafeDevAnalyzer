...
from slither_core.analyses.data_dependency.data_dependency import get_dependencies
...
from slither_core.tools.read_storage.read_storage import SlotInfo, SlitherReadStorage
from slither_core.utils.encoding import encode_ir_for_upgradeability_compare
