...
def get_library_candidate(filename: Filename, contract_name: str) -> List[str]:
    ...
    name_with_used_filename = filename.relative + ":" + contract_name
...
class SafeDevSourceUnit:
    """SourceUnit class"""

    def __init__(self, compilation_unit: "SafeDevCompilationUnit", filename: Filename):

        self.filename = filename
        self.compilation_unit: "SafeDevCompilationUnit" = compilation_unit
    ...
    @property
    def bytecodes_runtime(self) -> Dict[str, str]: #done
    ...
    def bytecodes_runtime(self, bytecodes: Dict[str, str]) -> None: #done
    ...
    @property 
    def bytecodes_init(self) -> Dict[str, str]: #done
    ...
    def bytecodes_init(self, bytecodes: Dict[str, str]) -> None: #done
    ...
    def bytecode_runtime(self, name: str, libraries: Optional[Dict[str, int]] = None) -> str:   #done
    ...
    def bytecode_init(self, name: str, libraries: Optional[Dict[str, int]] = None) -> str: #done
    ...
    @property
    def srcmaps_init(self) -> Dict[str, List[str]]: #done
    ...
    @property
    def srcmaps_runtime(self) -> Dict[str, List[str]]: #done
    ...
    def srcmap_init(self, name: str) -> List[str]: #done
    ...
    def srcmap_runtime(self, name: str) -> List[str]: #done
    ...
    def _update_bytecode_with_libraries( #done
