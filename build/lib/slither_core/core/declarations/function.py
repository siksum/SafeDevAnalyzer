...
from slither_core.utils.type import convert_type_for_solidity_signature_to_string
from slither_core.utils.utils import unroll
...
if TYPE_CHECKING:
    ...
    from slither_core.slithir.variables import LocalIRVariable
...
class Function(SourceMapping, metaclass=ABCMeta):  # pylint: disable=too-many-public-methods
    ...
    def return_values(self) -> List["SlithIRVariable"]:
        ...
        """
        from slither_core.core.cfg.node import NodeType
        from slither_core.slithir.operations import Return
    ...
    def _solidity_variable_in_internal_calls(node: "Node") -> List[SolidityVariable]:
        from slither_core.slithir.operations.internal_call import InternalCall
    ...
    def _get_last_ssa_variable_instances(
        ...
        from slither_core.slithir.variables import ReferenceVariable
        from slither_core.slithir.operations import OperationWithLValue
        from slither_core.core.cfg.node import NodeType
    ...
    def _unchange_phi(ir: "Operation") -> bool:
        from slither_core.slithir.operations import Phi, PhiCallback
    ...
    def fix_phi(
        ...
        from slither_core.slithir.operations import InternalCall, PhiCallback
        from slither_core.slithir.variables import Constant, StateIRVariable
