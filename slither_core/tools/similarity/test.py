...
from slither_core.tools.similarity.encode import encode_contract, load_and_encode, parse_target
from slither_core.tools.similarity.model import load_model
from slither_core.tools.similarity.similarity import similarity
